...
// ---------------------------------------------------------------------------
// 低音谱号字形（公有领域 SVG 路径，来源：Wikimedia Commons "Bass clef.svg"）。
// 路径坐标为原始字形坐标：五线间距 590.5 单位，两个点的中心位于 F 线
// （y=6968）两侧，点心距 524 单位（见下方 GLYPH_F_LINE / GLYPH_DOT_SPACING）。
// ---------------------------------------------------------------------------
const BASSCLEF_PATH =
  'M 1239,8245 C 1397,8138 1515,8057 1591,8001 C 1667,7946 1747,7877 1829,7795 C 1911,7713 1980,7620 2036,7517 C 2080,7441 2118,7353 2149,7253 C 2180,715' +
  '4 2196,7058 2199,6967 C 2199,6882 2188,6801 2165,6725 C 2143,6648 2105,6585 2051,6534 C 1997,6484 1927,6459 1840,6459 C 1756,6459 1677,6476 1603,6509 ' +
  'C 1530,6543 1478,6597 1449,6673 C 1449,6680 1445,6689 1439,6702 C 1441,6718 1449,6730 1464,6739 C 1479,6748 1492,6752 1504,6752 C 1510,6752 1527,6749 ' +
  '1553,6743 C 1580,6737 1602,6733 1620,6733 C 1673,6733 1720,6752 1763,6789 C 1805,6826 1826,6871 1826,6924 C 1826,6962 1815,6998 1794,7031 C 1773,7064 ' +
  '1744,7091 1707,7110 C 1670,7130 1629,7139 1585,7139 C 1505,7139 1437,7115 1381,7066 C 1326,7016 1298,6953 1298,6874 C 1298,6773 1329,6686 1390,6612 C ' +
  '1452,6538 1530,6483 1626,6446 C 1721,6408 1817,6390 1915,6390 C 2022,6390 2124,6417 2219,6472 C 2315,6526 2390,6601 2446,6694 C 2502,6788 2531,6888 25' +
  '31,6996 C 2531,7188 2467,7366 2339,7531 C 2211,7696 2053,7839 1864,7961 C 1738,8044 1534,8156 1253,8297 L 1239,8245 z M 2628,6698 C 2628,6662 2641,663' +
  '2 2667,6608 C 2692,6583 2723,6571 2760,6571 C 2792,6571 2822,6585 2849,6612 C 2876,6638 2889,6669 2889,6703 C 2889,6739 2875,6770 2849,6795 C 2821,681' +
  '9 2790,6831 2755,6831 C 2718,6831 2688,6819 2664,6792 C 2640,6766 2628,6735 2628,6698 z M 2628,7222 C 2628,7186 2641,7155 2665,7131 C 2690,7106 2721,7' +
  '094 2760,7094 C 2792,7094 2821,7107 2849,7134 C 2875,7161 2889,7190 2889,7222 C 2889,7261 2876,7292 2851,7317 C 2825,7342 2795,7355 2760,7355 C 2721,7' +
  '355 2690,7342 2665,7318 C 2641,7294 2628,7262 2628,7222 z';
// 字形坐标系中的关键几何：F 线（第 4 线）y 坐标与五线间距
const GLYPH_F_LINE_Y = 6968;
const GLYPH_LINE_SPACING = 590.5;
// 字形中两个点的中心（用于把点对齐到 F 线）
const GLYPH_DOT_CX = 2760;
...
export function drawBassClefAt(ctx, { x, line1Y, gap }) {
  ...
  if (path) {
    ...
    const scale = (2 * gap) / GLYPH_LINE_SPACING;
    ctx.save();
